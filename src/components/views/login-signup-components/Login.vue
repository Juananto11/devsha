        ...
        .col
          .form-group.has-danger
            ...
            .input-group.mb-2.mt-1
              .input-group-addon
                i
              input#email.form-control(type='email', name='email', placeholder='you@example.com', v-model="userToLogin.email", v-validate="'required|email'")
        ...
        .col
          .form-group
            ...
            .input-group.mb-2.mt-1
              .input-group-addon
                i
              input#password.form-control(type='password', name='password', placeholder='Password', v-model="userToLogin.password", v-validate="'required|min:8'")
          .form-control-feedback
        ...
        .col
          .form-check.mb-2
            label.form-check-label.mt-2
              input.form-check-input(name='remember', v-model='userToLogin.remember' type='checkbox')
              span Recuérdame
